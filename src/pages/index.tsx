  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of dining with Restaurant Booking Engine v3 - Streamlining reservations and menu management for superior restaurant operations and customer satisfaction."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of dining with Restaurant Booking Engine v3 - Streamlining reservations and menu management for superior restaurant operations and customer satisfaction.`}
            </Text>
            <Box
